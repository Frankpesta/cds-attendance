      ...
      render: (_: any, item: any) => (
        <div className="flex gap-2">
          <Button
            ...
            size="sm"
            onClick={() => {
              // Find the full record from corpMembers to ensure all fields including SAED are included
              const fullRecord = corpMembers?.find((m: any) => m._id === item._id);
          ...
          <CardContent className="space-y-4 text-sm max-h-[calc(100vh-300px)] overflow-y-auto">
            ...
            {selectedRecord && (
              <>
                ...
                {/* SAED Information Section - Always show to display all SAED fields */}
                <div className="border-t pt-4 mt-4 space-y-3">
                  ...
                  {(selectedRecord.selected_trainer_name || selectedRecord.selected_trainer_business || selectedRecord.selected_trainer_phone || selectedRecord.selected_trainer_email) && (
